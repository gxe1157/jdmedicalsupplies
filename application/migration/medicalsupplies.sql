...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2017 at 12:50 AM
...
(1, 'Postal Supplies', 0, 'Postal-Supplies'),
(2, 'Rubber Bands', 1, 'Rubber-Bands');
...
INSERT INTO `store_items` (`id`, `item_title`, `item_url`, `item_price`, `item_description`, `item_setup`, `product_id`, `model_no`, `big_pic`, `small_pic`, `was_price`, `status`, `create_date`, `mod_dt`, `userid`) VALUES
(1, '#64 Rubber bands', '64-Rubber-bands', '10.00', '#64 Rubberbands', 1, '', '', 'Desert.jpg', 'Desert.jpg', '12.00', 1, 0, 0, 0);
...
(6, 'Industries-We-Insure', 'Industries We Insure', '                                 ', '                                 ', '                                 ', 0, 0, 0, 0),
(7, 'Property', 'Property', '                      ', '                      ', '                      ', 0, 0, 0, 0),
(8, 'Flood-Insurance', 'Flood Insurance', '           ', '           ', '           ', 0, 0, 0, 0),
(9, 'Health-Insurance', 'Health Insurance', '           ', '           ', '           ', 0, 0, 0, 0),
(10, 'General-Liability', 'General Liability ', '           ', '           ', '           ', 0, 0, 0, 0),
(11, 'Liquor-Liability', 'Liquor Liability', '           ', '           ', '           ', 0, 0, 0, 0),
(12, 'Workers-Compensation', 'Workers Compensation', '           ', '           ', '           ', 0, 0, 0, 0),
(13, 'Assault-and-Battery', 'Assault and Battery', '                      ', '                      ', '                      ', 0, 0, 0, 0),
(14, 'Commercial-Crime-Coverage', 'Commercial Crime Coverage', '           ', '           ', '           ', 0, 0, 0, 0),
(15, 'News', 'News', '           ', '           ', '           ', 0, 0, 0, 0),
(16, 'commercial-property-insurance', 'Commercial Property Insurance', '', '', '', 0, 0, 0, 0),
...
--
ALTER TABLE `captcha`
  MODIFY `captcha_id` bigint(13) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
