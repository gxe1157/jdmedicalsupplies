...
<div class="row">
	...
	<?= validation_errors("<p style='color: red;'>", "</p>") ?>
			...
			<p>Choose a webpage to be assigned and hit 'Submit' </p>
				  ...
				  <div class="col-md-5">
						<?php
							$additional_opt = array( 'id' => 'selectStatus',
													 ...
													 'class' =>'form-control' );
							echo form_dropdown('webpage_id', $options, 0, $additional_opt);
						?>
				  </div>
				</div>
		        ...
		        $count = 0;
			   	foreach( $query->result() as $row ){
					...
					?> 	
						<tr>
							<td><?= $count ?></td>
							<td class="right"><?= $webpages[$row->$store_db_column] ?></td>
							<td class="center">
