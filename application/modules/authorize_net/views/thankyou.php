    ...
    <div class="row">
      <div class="col-md-5 border">
        ...
        <div class="row">
          ...
          <div class="col-sm-7 col-md-8 border hsides"><b><?= $response['AccountType'] ?></b><br>
            Card Number: <?= $response['AccountNumber'] ?><br>
            Authorization No: <?= $response['AuthCode'] ?><br>
            Transaction Id: <?= $response['TransId'] ?></div>            
        </div>  
