...
function order_details( $payment_id, $data) 
{
    ...
    $sql = "INSERT INTO `store_orders_details` SELECT * FROM `store_basket` WHERE `cart_id` = '".$cart_id."'";
    $this->model_name->_custom_query($sql);

    /* Update shopper_id. It may be empty from store_basket table */
    $sql2 = "UPDATE `store_orders_details` SET `shopper_id`='".$shopper_id."', `create_date`='".time()."' WHERE `cart_id` ='".$cart_id."'";
