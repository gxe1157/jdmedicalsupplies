		...
		<div class="container">
			<div class="footer-top-bg row">
				...
				<div class="col-md-4 footer-box three">
					...
					<div class="footer-box-content">
						<p style="margin-top: 10px;">info@jdmedicalsupplies.org</p>
					</div>
				</div><!--/ Box 3 end -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-sm-12 footer-widget footer-about">
					...
					<p><strong>Office Hours:<br>Monday - Friday</strong> 9:00 am - 5:00 pm</p>
				</div><!-- About us end -->
			...
			<div class="row copyright">
				<div class="col-xs-12 col-sm-5">
					<div class="copyright-info">
						<span>Copyright © <?php echo date("Y");?> J&D Medical Supplies. All Rights Reserved.</span>
					</div>
				</div>
